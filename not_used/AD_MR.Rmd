...
#SUHRE
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR//suhr_mr/output2021/")
...
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/output2021/")
...
deco_n <- count(deco_mr)

# Because DECO is huge, need this to make new run files in case the run stops before all of them are analyzed. FALSE means nothing will happen
find_lost = FALSE
...
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list1.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list1.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list2.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list2.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list3.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list3.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list4.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list4.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list5.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list5.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list6.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list6.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list7.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list7txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list8.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list8.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list9.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list9.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/list10.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/list10.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
```{r echo=FALSE}
total_tests <- sum(ahol_n$n, folk_n$n, scal_n$n, sliz_n$n, suhre_n$n, sun_n$n, wood_n$n, hill_n$n, hogl_n$n, enroth_n$n, deco_n$n)
...
#SUHRE
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR//suhr_mr/ADexp/output/")
...
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR//deco_mr/ADexp/output/")
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list1.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list1.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list2.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list2.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list3.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list3.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list4.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list4.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list5.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list5.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list6.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list6.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list7.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list7.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list8.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list8.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list9.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list9.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/deco_mr/ADexp/list10.txt", nrows = 500, header = FALSE)
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/deco_mr/ADexp/list10.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
if(make_list == TRUE) {
list <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list.txt")
...
all <- read.table("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/deco.txt")
...
```{r echo=FALSE}
total_tests <- sum(ahol_n$n, folk_n$n, scal_n$n, sliz_n$n, suhre_n$n, sun_n$n, wood_n$n, hill_n$n, hogl_n$n, enroth_n$n, deco$n)
...
for(number in 1:length(filename)){
  ...
  file_path_gsmr <- paste0(path,study[number],"_mr/","output2021/",current_marker,".eff_plot.gz")
...
for(number in 49:length(filename)){
...
for(number in 1:length(filename)){
  ...
  graph <- plot_gsmr_effect(gsmr_data,"AD_Schwartzentruber",marker[number], colors()[75])

  ggsave(filename = paste0(marker[number]), plot = graph, path = paste0(path,"/sensitivity/AD_exposure/"), width = 6, height = 4, device='tiff', dpi=700)

  snp_data <- gsmr_snp_effect(gsmr_data,"AD_Schwartzentruber",marker[number])
...
for(number in 1:length(filename)){
  ...
  test <- clump_data(exposure_dat, clump_r2 = 0.05)
  ...
  #save plot
  try({ggsave(filename = paste0(marker[number],"_",brain[number]), plot = save_plot, path = paste0(path,"sensitivity/AD_exposure/2SMR/plots/"), width = 6, height = 4, device='tiff', dpi=700)})
...
AD_outcome_stringent$file_name <- tools::file_path_sans_ext(AD_outcome_stringent$file_name)
...
for(number in 1:length(filename)){
  ...
  file_path_gsmr <- paste0(path,study[number],"_","mr/output2021/",current_marker,".eff_plot.gz")
  ...
  write.table(snp_data, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR//sensitivity/",marker[number]), col.names=T, row.names=F, quote=F,sep = "\t")
...
AD_outcome_mvmr <- AD_outcome_stringent

AD_outcome_mvmr <- AD_outcome_mvmr %>%
  filter(Beta > 0)

# AD_outcome_mvmr$Exposure <- sub("^(.*)[.].*", "\\1",AD_outcome_mvmr$Exposure)
# AD_outcome_mvmr$Exposure <- sub("^(.*)[.].*", "\\1",AD_outcome_mvmr$Exposure)
# AD_outcome_mvmr$Exposure <- sub("^(.*)[.].*", "\\1",AD_outcome_mvmr$Exposure)
# AD_outcome_mvmr$Exposure <- sub("^(.*)[.].*", "\\1",AD_outcome_mvmr$Exposure)

AD_outcome_mvmr$study <- tolower(AD_outcome_mvmr$study)
AD_outcome_mvmr$file_name <- sub('\\..*', '', AD_outcome_mvmr$file_name)

filename <- AD_outcome_mvmr$file_name
...
ad <- fread(paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/AD_Schwartzentruber.txt"), verbose = T, data.table = F, fill=TRUE)
...
for(number in 1:length(filename)){ #change to for(number in 1:length(filename)){
  ...
  ename <- paste0(marker[number])
  ename
  zones[[ename]] <- fread(paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/sensitivity/",marker[number]), verbose = T, data.table = F, fill=TRUE)
...
for(number in 1:length(filename)){ #change to for(number in 1:length(filename)){
  ...
  names(joined_data)[names(joined_data) == "BETA"] <- paste0(marker[number],"_beta")

}

# save the data frame half way as this keep crashing
#export the final data frame as it takes such a long time to make
write.table(joined_data, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR//sensitivity/joined_data_positive"), col.names=T, row.names=F, quote=F,sep = "\t")
...
joined_data <- fread(paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR//sensitivity/joined_data_positive"), verbose = T, data.table = F, fill=TRUE)
...
# save the data frame half way as this keep crashing
#export the final data frame as it takes such a long time to make
write.table(joined_data, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR//sensitivity/joined_data_negative"), col.names=T, row.names=F, quote=F,sep = "\t")
...
#import the data frame and make a labelled list
joined_data <- fread(paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR//sensitivity/joined_data_negative"), verbose = T, data.table = F, fill=TRUE)
