...
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/output/")
...
for(n in 1:length(deco_mr)){

  df <- as.data.frame(deco_mr[n])

  df$file_name <- paste(deco_list[n])

  temp <- df

  deco_df <- rbind(deco_df, temp)
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list1.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list1.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list2.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list2.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list3.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list3.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list4.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list4.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list5.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list5.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list6.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list6.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list7.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list7.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list8.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list8.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list9.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list9.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list10.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/deco/list10.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
```{r echo=FALSE}
total_tests <- sum(ahol_n$n, folk_n$n, scal_n$n, suhre_n$n, sun_n$n, wood_n$n, hill_n$n, hogl_n$n, enroth_n$n, deco_n$n)
...
protein_outcome_filtered_brainexposure <- subset(protein_outcome_filtered, nchar(as.character(Exposure)) >= 10)
protein_outcome_filtered <- subset(protein_outcome_filtered, nchar(as.character(Exposure)) <= 10)
...
setwd("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/output/")
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list1.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list1.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list2.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list2.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list3.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list3.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list4.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list4.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list5.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list5.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list6.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list6.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list7.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list7.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list8.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list8.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list9.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list9.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
worked = data.frame(worked)
worked$worked <-   gsub("\\..*","",worked$worked)
list <- read.table("/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list10.txt")
names(list)[1] <- "worked"
test <- setdiff(list$worked, worked$worked)
test = data.frame(test)
names(test)[1] <- "worked"
re_do <- merge(test, list)
write.table(x = re_do, file = "/mnt/lustre/groups/ukbiobank/Edinburgh_Data/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/deco/list10.txt", quote = FALSE, row.names = FALSE, col.names = FALSE, sep = "\t ")
}
...
protein_exposure_filtered_brainexposure <- subset(protein_exposure_filtered, nchar(as.character(Exposure)) >= 9)
protein_exposure_filtered <- subset(protein_exposure_filtered, nchar(as.character(Exposure)) <= 10)
...
sheets <- getSheetNames(paste0(path,"AD_protein_brain_sig.xlsx"))
...
for(number in 1:length(filename)){
  ...
  current_protein <- readWorkbook(xlsxFile = paste0(path,"AD_protein_brain_sig.xlsx"), sheet = sheets[number], rowNames = TRUE)
  ...
  original_protein <- fread(paste0("/scratch/groups/ukbiobank/sumstats/cleaned/blood_biomarkers/",filename[number],".gz"), verbose = T, data.table = F, fill=TRUE)
  ...
  write.table(full_df, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/sensitivity/",marker[number]), col.names=T, row.names=F, quote=F,sep = "\t")

  #get the brain volume that we are interested in as well
  original_brainvol <- fread(paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/brain_vol/",brain[number],".txt"), verbose = T, data.table = F, fill=TRUE)
  ...
  brain_df_matchesSNP <- subset(brain_df, SNP %in% full_df$SNP)

  #write this as a table
  write.table(brain_df_matchesSNP, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/sensitivity/",brain[number]), col.names=T, row.names=F, quote=F,sep = "\t")

  #using TwoSampleMR, read in the exposure of interest
  exposure_dat <- read_exposure_data(
  filename = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/sensitivity/",marker[number]),
  sep = "\t",                
  snp_col = "SNP",          
  beta_col = "BETA",         
  se_col = "SE",        
  ...
  exposure_dat$exposure=paste0(marker[number])

  #using TwoSampleMR, read in the outcome of interest
  outcome_dat <- read_outcome_data(
  filename = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/AD_protein/sensitivity/",brain[number]),
  sep = "\t",                
  snp_col = "SNP",          
  beta_col = "BETA",         
  se_col = "SE",        
  ...
  outcome_dat$outcome=paste0(brain[number])
...
saveWorkbook(wb, file = paste0(path,"sensitivity/protein_AD_brain_sig.xlsx"), overwrite = TRUE)
...
for(number in 1:length(filename)){
  ...
  #read in the workbook with all our significant proteins
  current_protein <- readWorkbook(xlsxFile = paste0(path,"sensitivity/protein_AD_brain_sig.xlsx"), sheet = paste0(all_protein[number]), rowNames = TRUE)
  ...
  #write this newly joined data frame as a table
  write.table(full_df, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/sensitivity/",marker[number]), col.names=T, row.names=F, quote=F,sep = "\t")
  ...
  #write this as a table
  write.table(brain_df, file = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/sensitivity/",brain[number]), col.names=T, row.names=F, quote=F,sep = "\t")

  #using TwoSampleMR, read in the exposure of interest
  exposure_dat <- read_exposure_data(
  filename = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/sensitivity/",marker[number]),
  sep = "\t",                
  snp_col = "SNP",          
  beta_col = "BETA",         
  se_col = "SE",        
  ...
  #using TwoSampleMR, read in the outcome of interest
  outcome_dat <- read_outcome_data(
  filename = paste0("/scratch/groups/ukbiobank/usr/alish/AD_MR/protein_brainvol_MR/protein_AD/sensitivity/",brain[number]),
  sep = "\t",                
  snp_col = "SNP",          
  beta_col = "BETA",         
  se_col = "SE",        
  ...
  #save plot
  try({ggsave(filename = paste0(marker[number],"_",brain[number]), plot = save_plot, path = paste0(path,"sensitivity/plots/"), width = 6, height = 4, device='tiff', dpi=700)})
